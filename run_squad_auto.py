...
def predict(args, model, tokenizer, prefix="", val_or_test="val"):
    if val_or_test == "val":
        ...
        try:
            nsml.load("ValidationDataset", load_dataset, 'kaist0015/korquad-open-ldbd3/264')
        ...
        try:
            nsml.load("TestDataset", load_dataset, 'kaist0015/korquad-open-ldbd3/264')
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False, val_or_test="val"):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        try:
            nsml.load("PreprocessedDataset", load_dataset, 'kaist0015/korquad-open-ldbd3/264')
